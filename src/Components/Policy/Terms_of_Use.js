...
import './CSS/Terms_of_Use.css'; // Import your CSS file
  ...
  return (
    ...
    <div className='terms-container'>
      ...
      <div className='terms-content'>
        ...
        <h2>2. CONTRACTUAL RELATIONSHIP</h2>
        <p>
        ...
        <p>
          4.4. You acknowledge that even after accepting and/ or confirming an order, the Company cannot guarantee its availability. The Company shall make reasonable efforts to connect you with the independent sellers in order to fulfill your order.
        </p>
        ...
        <h2>5. GENERAL TERMS OF USE(S)</h2>
        <p>
        ...
        <h2>6. CONDUCT</h2>
        <p>
          6.1. that is unlawful, harmful, threatening, abusive, harassing, defamatory, libelous, invasive of another's privacy, or is harmful to minors in any way;
        </p>

        <p>
          6.2. that is pornographic in nature;
        </p>

        <p>
          6.3. that harasses degrades, intimidates or is hateful toward an individual or group of individuals on the basis of religion, gender, sexual orientation, race, ethnicity, age, or disability;
        </p>

        <p>
          6.4. that impersonates any person or entity or falsely states or otherwise misrepresents your affiliation with a person or entity;
        </p>

        <p>
          6.5. that includes personal or identifying information about another person without that person's explicit consent;
        </p>
        <p>
          6.6. that is false, deceptive, misleading, deceitful, or constitutes "bait-and-switch";
        </p>
        <p>
          6.7. that infringes any patent, trademark, trade secret, copyright or other proprietary rights of any party, or Content that you do not have a right to make available under any law or under contractual or fiduciary relationships;
        </p>
        <p>
          6.8. that constitutes or contains "affiliate marketing," "link referral code," "junk mail," "spam," "chain letters," "pyramid schemes," or unsolicited commercial advertisement; that constitutes or contains any form of advertising or solicitation;
        </p>
        <p>
          6.9. that includes links to commercial services or platform(s)s, except as allowed in "services";
        </p>
        <p>
          6.10. that advertises any illegal service or the sale of any items the sale of which is prohibited or restricted by any applicable law, including without limitation items the sale of which is prohibited or regulated by Indian law.
        </p>
        <p>
          6.11. that contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of any computer software or hardware or telecommunications equipment;
        </p>
        <p>
          6.12. that disrupts the normal flow of dialogue with an excessive number of messages (flooding attack) to the service, or that otherwise negatively affects other users' ability to use the service; or
        </p>
        <p>
          6.13. that employs misleading email addresses, or forged headers or otherwise manipulated identifiers in order to disguise the origin of Content transmitted through the service.
        </p>
        <p>
          6.14. Additionally, you agree not to:
        </p>
        <p>6.14.1. contact anyone who has asked not to be contacted;</p>
        <p>6.14.2. "stalk" or otherwise harass anyone;</p>
        <p>6.14.3. collect personal data about other users for commercial or unlawful purposes;</p>
        <p>6.14.3 use automated means, including spiders, robots, crawlers, data mining tools, or the like to download data from the Service - unless expressly permitted by boodmo;</p>
        <p>6.14.4. post non-local or otherwise irrelevant Content, repeatedly post the same or similar Content or otherwise impose an unreasonable or disproportionately large load on our infrastructure;</p>
        <p>6.14.5. attempt to gain unauthorized access to boodmo’s computer systems or engage in any activity that disrupts, diminishes the quality of, interferes with the performance of, or impairs the functionality of, the Service or the boodmo platform(s); or</p>
        <p>6.14.6. use any form of automated device or computer program that enables the submission of postings on boodmo without each posting being manually entered by the author thereof (an "automated posting device"), including without limitation, the use of any such automated posting device to submit postings in bulk, or for automatic submission of postings at regular intervals.</p><hr />
        <h2>7. DO-IT-YOURSELF AND CAR CARE TIPS OR ARTICLES</h2>
        <p>
          7.1 The information contained in car care articles, tips, do-it-yourself guides, is for knowledge and educational purposes only and cannot substitute for the advice of a professional car/auto mechanic or authorized car workshop or authorized car part dealer or service station. Please don't attempt to replace your car parts if you don't have proper knowledge and tools, you can be injured and your vehicle could be damaged. Take your car to a dealer or a workshop.
        </p><hr />
        <h2>8. CONTACTING YOU</h2>
        <p>
          8.1 The Company reserves the right to contact you through telephone, email, SMS, or any other means of communication for the purpose of obtaining feedback in relation to platform(s) or our Services; obtaining feedback in relation to any other users listed on the platform(s); or resolving any complaints, information, or queries by other users regarding your critical content. You agree to provide your fullest cooperation further to such communication by the Company. You agree that we can use and share your feedback for any purpose without any compensation to you and we are under no obligation to keep such feedback confidential.
        </p><hr/>
        <div className="grievance-officer-content">
          ...
          <ul>
            <li><strong>Name:</strong> Mr. Nitish Kumar</li>
            <li><strong>Designation:</strong> Manager – Sales & CRM</li>
            <li><strong>Company:</strong> Smart Parts Online Private Limited</li>
            <li><strong>Address:</strong> AIHP Palms, Plot No. 242 & 243, Ground floor, Udyog Vihar, Phase IV, Gurugram, Haryana - 122015, India</li>
            <li><strong>Email:</strong> <a href="mailto:grievance@boodmo.com">grievance@boodmo.com</a></li>
          </ul>
        </div>
      </div>
      <div className="custom-copyright-text">
